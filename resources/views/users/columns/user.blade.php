<div class="d-flex align-items-center">
    <a href="javascript:void(0)" data-id="{{ $row->id }}" class="show-btn">
        <div class="image image-mini me-3">
            <img src="{{ !empty($row->image_url) ? asset('uploads/profile_images/' . $row->image_url) : asset('assets/img/avatar.png') }}"
                alt="user" class="user-img image rounded-circle object-contain">
