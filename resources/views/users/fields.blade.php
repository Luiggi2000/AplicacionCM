    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-5">
            <div class="justify-content-center">
                {{ Form::label('image_url', __('messages.common.profile') . ':', ['class' => 'form-label']) }}
            </div>

            @php
                if ($isEdit) {
                    $image = !empty($user->image_url)
                        ? asset('uploads/profile_images/' . $user->image_url)
            ...
            <div class="image previewImage" id="userPreviewImage" style="background-image: url('{{ $image }}')">
            </div>
                ...
                <div class="image-picker">
                    ...
                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                        ...
                        <label>
                            ...
                            {{ Form::file('image_url', ['id' => 'userProfileImages', 'class' => 'd-none image-upload', 'tabindex' => '12', 'accept' => '.png, .jpg, .jpeg']) }}
