        ...
        <div class="row justify-content-between">
            <div class="col-lg-4 col-md-7 mb-md-0 mb-3">
                <div class="footer-logo">
                    <img src="{{ $settingValue['app_logo']['value'] ?? asset('images/default-logo.png') }}" alt="HMS-Sass"
                        class="img-fluid" id="footer-logo-white-img" />

                </div>
                <p class="d-block text-white mt-4">
                    {!! $settingValue['footer_text']['value'] ?? 'Texto del pie de página' !!}
                </p>
            </div>
            ...
            <div class="col-12 text-center mt-lg-5 mt-4  copy-right">
                <p class=" pt-4 pb-4 mb-0 text-white">{{ __('messages.web_menu.copyright') }} © {{ date('Y') }}
                    <b>{{ $settingValue['app_name']['value'] ?? '' }}</b> | {{ __('messages.landing.all_rights_reserved') }}
                </p>
            </div>
