            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-lg-row">
                    <div class="col-lg-6 text-lg-start text-center">
                        <div class="banner-content mt-lg-0 mt-sm-5 mt-4 pe-lg-4">
                            ...
                            <span class="ps-xl-2 mb-3 mb-lg-0 d-lg-block mt-3 d-none">{{ __('messages.landing.call') }} :
                                <a href="tel:{{ $phone }}" class="text-decoration-none text-primary">
                                    {{ $phone }}
                                </a>
                            </span>
                        </div>
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ url('uploads/profile_images/section.png') }}" alt="manage hospital" class="img-fluid"
                            loading="lazy" />
                    </div>
                </div>
            </div>
                ...
                <div class="protect-health">
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-md-6 my-xl-0 py-xl-0 my-2 py-1">
                            <div class="card">
                                <div
                                    class="row justify-content-md-between justify-content-center text-center text-sm-start">
                                    ...
                                    <div class="col-md-8 col-sm-9">
                                        <div class="card-body p-0">
                                            ...
                                            <p class="card-text">
                                                {{ html_entity_decode($sectionTwo['card_one_text_secondary'] ?? '') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="col-md-8 col-sm-9">
                                        <div class="card-body p-0 ">
                                            ...
                                            <p class="card-text">
                                                {{ html_entity_decode($sectionTwo['card_two_text_secondary'] ?? '') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" col-lg-6">
                                <div class="sass-left-content bg-light">
                                    <div class="d-flex align-items-center justify-content-lg-end flex-wrap">
                                        <img class="img-fluid"
                                            src="{{ isset($sectionThree['img_url']) ? asset($sectionThree['img_url']) : asset('landing_front/images/frame_9.png') }}"
                                            alt="" loading="lazy">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="sass-desc mb-4">
                                        <div class="row">
                                            <div class="col-sm-6 d-flex align-items-center mb-3 pb-1">
                                                <i
                                                    class="fa-solid fa-check d-flex align-items-center justify-content-center me-2 text-white bg-primary"></i>
